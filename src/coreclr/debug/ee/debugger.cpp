...
BOOL Debugger::IsThreadContextInvalid(Thread *pThread, CONTEXT *pCtx)
{
    ...
    if (success)
    {
        ...
        if (IsSSFlagEnabled(reinterpret_cast<DT_CONTEXT *>(pCtx) ARM_ARG(pThread) ARM64_ARG(pThread) LOONGARCH64_ARG(pThread) POWERPC64_ARG(pThread) RISCV64_ARG(pThread)))
        {
