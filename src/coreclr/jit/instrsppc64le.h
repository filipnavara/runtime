...
INST(rlwinm,        "rlwinm",         0,    0x54000000)
INST(rlwnm,         "rlwnm",          0,    0x5C000000)
INST(rldicl,        "rldicl",         0,    0x78000000)
INST(rldcl,         "rldcl",          0,    0x78000010)
...
INST(fabs,          "fabs",           0,    0xFC000210)
INST(fneg,          "fneg",           0,    0xFC000050)
INST(frsp,          "frsp",           0,    0xFC000018)
INST(fsqrt,         "fsqrt",          0,    0xFC00002C)
INST(fsqrts,        "fsqrts",         0,    0xEC00002C)
...
INST(mtfprd,        "mtfprd",         0,    0x7C000166)
INST(xscvdpspn,     "xscvdpspn",      0,    0xF000042C)
INST(xscvspdpn,     "xscvspdpn",      0,    0xF000052C)
INST(mffprd,        "mffprd",         0,    0x7C000066)
INST(mtfprwz,       "mtfprwz",        0,    0x7C0001E6)
INST(mffprwz,       "mffprwz",        0,    0x7C0000E6)
...
INST(ldarx,         "ldarx",          LD,   0x7C0000A8)
INST(lwarx,         "lwarx",          LD,   0x7C000028)
...
INST(stdcx,         "stdcx.",         ST,   0x7C0001AD)
INST(stwcx,         "stwcx.",         ST,   0x7C00012D)
