    ...
    if (src->TypeIs(TYP_STRUCT))
    {
        ...
        if (regType == TYP_UNDEF)
        {
            ...
            if (!layout->HasGCPtr())
            {
                ...
                {
                    putArgStk->gtPutArgStkKind = putArgStk->putInIncomingArgArea() ? GenTreePutArgStk::Kind::Unroll : GenTreePutArgStk::Kind::Push;
                }
                else
#endif // TARGET_X86
            ...
            else // There are GC pointers.
            {
                ...
                // `push` instructions.
                putArgStk->gtPutArgStkKind = putArgStk->putInIncomingArgArea() ? GenTreePutArgStk::Kind::PartialRepInstr : GenTreePutArgStk::Kind::Push;
#else  // !TARGET_X86
...
void Lowering::LowerCast(GenTree* tree)
{
        ...
        !comp->compOpportunisticallyDependsOn(InstructionSet_AVX10v2))
    {
        ...
        else
        {
            ...
            assert(!TargetArchitecture::Is64Bit || comp->compIsaSupportedDebugOnly(InstructionSet_X86Base_X64));
            ...
            switch (dstType)
            {
                ...
                case TYP_UINT:
                {
                    ...
                    if (srcType == TYP_FLOAT)
                    {
                        ...
                        convertIntrinsic        = comp->compOpportunisticallyDependsOn(InstructionSet_X86Base_X64)
                ...
                case NI_Vector512_ToScalar:
                {
                    ...
                    if (isContainable && varTypeIsIntegral(simdBaseType))
                    {
                        ...
                        if (isContainable && varTypeIsSmall(simdBaseType))
                        {
                            ...
                            intrinsicId = varTypeIsByte(node) ? NI_SSE41_Extract : NI_X86Base_Extract;
