...
namespace System.CommandLine
{
    ...
    internal static partial class Helpers
    {
        ...
        public static string[] ValidArchitectures { get; } = ["arm", "armel", "arm64", "x86", "x64", "ppc64le", "riscv64", "loongarch64", "wasm"];
        ...
        public static TargetArchitecture GetTargetArchitecture(string token)
        {
            if (string.IsNullOrEmpty(token))
            {
                return RuntimeInformation.ProcessArchitecture switch
                {
                    ...
                    Architecture.Ppc64le => TargetArchitecture.Ppc64le,
            ...
            else
            {
                return token.ToLowerInvariant() switch
                {
                    ...
                    "ppc64le" => TargetArchitecture.Ppc64le,
