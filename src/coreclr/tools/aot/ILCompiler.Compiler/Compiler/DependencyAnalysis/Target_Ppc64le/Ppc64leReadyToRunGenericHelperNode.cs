...
namespace ILCompiler.DependencyAnalysis
{
    ...
    {
        protected Register GetContextRegister(ref /* readonly */ Ppc64leEmitter encoder)
        {
        ...
        protected void EmitDictionaryLookup(NodeFactory factory, ref Ppc64leEmitter encoder, Register context, Register result, GenericLookupResult lookup, bool relocsOnly)
        {
        ...
        protected sealed override void EmitCode(NodeFactory factory, ref Ppc64leEmitter encoder, bool relocsOnly)
        {
        ...
        protected virtual void EmitLoadGenericContext(NodeFactory factory, ref Ppc64leEmitter encoder, bool relocsOnly)
        {
    ...
    {
        protected override void EmitLoadGenericContext(NodeFactory factory, ref Ppc64leEmitter encoder, bool relocsOnly)
        {
