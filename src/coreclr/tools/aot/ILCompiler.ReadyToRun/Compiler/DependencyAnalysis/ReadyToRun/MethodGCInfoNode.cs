        ...
        private IEnumerable<GCInfoComponent> EncodeDataCore(NodeFactory factory)
        {
            ...
            for (int frameInfoIndex = 0; frameInfoIndex < numFrameInfos; frameInfoIndex++)
            {
                ...
                else
                {
                    ...
                    else if ((targetArch == TargetArchitecture.ARM) || (targetArch == TargetArchitecture.ARM64) || (targetArch == TargetArchitecture.LoongArch64) || (targetArch == TargetArchitecture.RiscV64) || (targetArch == TargetArchitecture.Ppc64le))
                    {
